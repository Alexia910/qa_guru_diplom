...
- После завершения прогона тестов, специальный `Telegram Bot` отправляет в `Telegram` краткий вариант Allure Report
...
- [✓] Отображение кнопок в header
- [✓] Отображение курсов валют за наличные

В ветке `local_tests` дополнительно есть:
- [✓] Создание депозита
- [✓] Проверка перехода в демо-версию АЧ

#### API тесты:
- [✓] Отображение главной страницы оценки сайта
- [✓] Запрос вопроса из неначатого опроса
- [✓] Запрос вопроса из пройденного опроса
